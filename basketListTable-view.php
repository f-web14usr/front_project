...
foreach($basketList as $basket)
{
    ...
    <td><a href ='deleteBasket-controler.php?id={$p_ditail['id']}'class='icon-btn like'>  <i class='fas fa-trash    '></i></a></td>
    </tr>
...
echo" </table>
      <br>
       <button  class='btn btn-filled success 'name='submit'><i class='fas fa-check'></i> ثبت تغیرات   </button>
